...
const createTripController = async (req, res) => {
  ...
  async function run() {
    ...
    //   // Morning Schedule
    //   console.log("Morning:");
    //   console.log(`Place: ${dayDetails.morning.placeName}`);
    //   console.log(`Time: ${dayDetails.morning.time}`);
    //   console.log(`Description: ${dayDetails.morning.description}`);
    //   console.log(`Imageurl: ${dayDetails.morning.placeImageUrl}`);
    //   console.log(`Google: ${dayDetails.morning.googleMapUrl}`);
      
    //   // Afternoon Schedule
    //   console.log("Afternoon:");
    //   console.log(`Place: ${dayDetails.afternoon.placeName}`);
    //   console.log(`Time: ${dayDetails.afternoon.time}`);
    //   console.log(`Description: ${dayDetails.afternoon.description}`);
    //   console.log(`Placeurl: ${dayDetails.afternoon.placeimageUrl}`);
    //   console.log(`Google: ${dayDetails.afternoon.googleMapUrl}`);
    // }
...
const showTripController =async(req,res)=>{
  const {email}=req.params;
  if(!email){
    return res.status(400).json({message:"Email is required"})
  }
  const trip=await Trip.find({user:email});
  if(!trip){
...
const showSingleTripController = async(req,res)=>{
...
const deleteSingleTripController = async(req,res)=>{
  const {email,id}=req.params;
  if(!email || !id){
    return res.status(400).json({message:"Email and Id is required"})
  }
  ...
  return res.status(201).json({message:"The trip is deleted"});
}

export { createTripController,showTripController ,showSingleTripController, deleteSingleTripController};
